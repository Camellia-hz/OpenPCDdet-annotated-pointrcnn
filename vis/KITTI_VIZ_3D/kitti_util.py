...
def draw_projected_box3d(image, qs, color=(255, 255, 255), thickness=2):
    ...
    for k in range(0, 4):
        ...
        cv2.line(image, (qs[i, 0], qs[i, 1]), (qs[j, 0], qs[j, 1]), color, thickness)
    # draw heading
    cv2.line(image, (qs[0, 0], qs[0, 1]), (qs[5, 0], qs[5, 1]), (0, 255, 0), thickness)
    cv2.line(image, (qs[1, 0], qs[1, 1]), (qs[4, 0], qs[4, 1]), (0, 255, 0), thickness)
    return image
...
def draw_vertical(x1, x2, x3, x4, y1, y2, y3, y4, z1, z2, z3, z4, x11, x22, x33, x44, y11, y22, y33, y44, z11, z22, z33,
                  z44):
    color = [0, 255, 0]
    d = 50
...
def draw_3D_box(x1, x2, x3, x4, y1, y2, y3, y4, z1, z2, z3, z4, x11, x22, x33, x44, y11, y22, y33, y44, z11, z22, z33,
                z44):
    up = draw_2D_box(x1, x2, x3, x4, y1, y2, y3, y4, z1, z2, z3, z4)

    down = draw_2D_box(x11, x22, x33, x44, y11, y22, y33, y44, z11, z22, z33, z44)

    vertical = draw_vertical(x1, x2, x3, x4, y1, y2, y3, y4, z1, z2, z3, z4, x11, x22, x33, x44, y11, y22, y33, y44,
                             z11, z22, z33, z44)
